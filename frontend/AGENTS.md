...
- Admin tables hide internal IDs behind hover tooltips; asset jump links are on the title cell; subtitle tracks show the video name.
- Admin assets table no longer displays uploader information.
...
- Home grid thumbnails enforce a fixed 16:9 ratio via inline padding-top + absolute media; grid uses auto-rows-max/content-start so cards don't compress, hides scrollbars, and auto-loads more items on scroll.
